...
![image-20201118161739463](.\MySql数据库.assets\image-20201118161739463.png)

![image-20201118161801062](.\MySql数据库.assets\image-20201118161801062.png)
...
![image-20201119105558325](.\MySql数据库.assets\image-20201119105558325.png)
...
![image-20201120101727886](.\MySql数据库.assets\image-20201120101727886.png)
...
![image-20201120111112439](.\MySql数据库.assets\image-20201120111112439.png)

	- 然后将我们的JAR包拷贝到lib目录中

![image-20201120111206144](.\MySql数据库.assets\image-20201120111206144.png)

- 选择目录，点击右键，选择 [add as libray] 这个时候就导入包成功了

![image-20201120111314325](.\MySql数据库.assets\image-20201120111314325.png)
...
![image-20201120192601302](.\MySql数据库.assets\image-20201120192601302.png)
...
​		![image-20201121160518512](.\MySql数据库.assets\image-20201121160518512.png)
